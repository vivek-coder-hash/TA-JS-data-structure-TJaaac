...
console.log(person2.firstName); // output  // Arya , because both share same address . It is copy by reference  .
...
console.log(personTwo.firstName); // output // John // shallow clonning
console.log(person.firstName); // output // Arya
